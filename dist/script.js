...
class JogoDaVelha {
    ...
    realizaJogada(event){
        ...
        //verifica se escolheu uma casa válida
        ...
        if (this.jogadas[id] != 0) {
            this.modal("Essa casa já foi escolhida");
            return;
        }
    ...
    enviarServidor(){
        ...
        domtoimage.toPng(this.velha, {with: '400', height:'400'})
            ...
            .then((response) => {
                this.modal('Enviado com Sucesso');
            })
            .catch((error) => {
